...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Produto p10 = new Produto (null, "Pendente", 180.00, null);
        Produto p11 = new Produto (null, "Shapoo", 90.00, null);
        Produto p12 = new Produto(null, "Produto 12", 10.00, null);
        Produto p13 = new Produto(null, "Produto 13", 10.00, null);
        Produto p14 = new Produto(null, "Produto 14", 10.00, null);
        Produto p15 = new Produto(null, "Produto 15", 10.00, null);
        Produto p16 = new Produto(null, "Produto 16", 10.00, null);
        Produto p17 = new Produto(null, "Produto 17", 10.00, null);
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", passwordEncoder.encode("123"),"36378912377", TipoCliente.PESSOAFISICA);
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Jhonnatan", "jhonnatan.war@hotmail.com", passwordEncoder.encode("123"),"36378912377", TipoCliente.PESSOAFISICA);
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("27363322", "93838392"));
